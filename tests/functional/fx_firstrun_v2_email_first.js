...
define([
  ...
  const PAGE_URL = `${config.fxaContentRoot}email?context=fx_firstrun_v2&service=sync`;
  ...
  registerSuite({
    ...
    //    .then(testIsBrowserNotified('fxaccounts:can_link_account'))
        ...
        .then(testElementTextEquals(selectors.SIGNUP_PASSWORD.EMAIL_NOT_EDITABLE, email))
  ...
  //      .then(testIsBrowserNotified('fxaccounts:can_link_account'))
        ...
        .then(testElementTextEquals(selectors.SIGNIN_PASSWORD.EMAIL_NOT_EDITABLE, email))
